...
export function TVQuickRail({
  ...
  const { data: accountStates } = useTVAccountStatesQuery(
    tvId,
    sessionId
  );
      ...
      <div className="space-y-2 border-t border-border/60 pt-3">
        ...
        <div className="grid grid-cols-1 gap-1.5">
          ...
          >
            ...
            />
            <span>
              {userRating ? `Your Rating: ${userRating}/10` : "Rate This Series"}
            </span>
          </Button>
          ...
          >
            ...
            <span>{copied ? "Copied Link!" : "Share Series"}</span>
          </Button>
        </div>
      </div>
    </div>
  ...
  return (
    <>
      ...
      {/* Mobile Sticky Collapsible Dropdown below Header */}
